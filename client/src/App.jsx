...
const AGENT_ICONS = {
  ...
  "Phoenix":   "https://media.valorant-api.com/agents/eb93336a-449b-9c1e-0ac7-dfe9992400f4/displayicon.png",
  ...
  "Skye":      "https://media.valorant-api.com/agents/6ebc1aad-4f06-9c4d-a00d-b5a834f4c9b7/displayicon.png",
  "Sova":      "https://media.valorant-api.com/agents/320b2a48-4d9b-a075-30f1-1f93a9b638fa/displayicon.png",
  "Tejo":      "https://media.valorant-api.com/agents/b444168c-4b9e-5f42-a0c0-b0d3e5b8b2a9/displayicon.png",
  "Viper":     "https://media.valorant-api.com/agents/707eab51-4836-f488-046a-cda6bf494859/displayicon.png",
  "Vyse":      "https://media.valorant-api.com/agents/efba5359-4016-a1e5-7626-b1ae976b468e/displayicon.png",
  "Yoru":      "https://media.valorant-api.com/agents/7f94d92c-4234-0a36-9646-3a87eb8b5edc/displayicon.png",
};
const AgentBadge = ({ name, size=32 }) => {
  const ag  = AGENTS.find(a=>a.name===name) || { color:"#8892aa", bg:"#141820" };
  const url = AGENT_ICONS[name];
  ...
  return (
    <div className="ab" style={{ width:size, height:size, background:ag.bg, border:`1px solid ${ag.color}28`, overflow:"hidden" }}>
      {url && !err
        ...
        : <span style={{ color:ag.color, fontSize:size*0.35, fontWeight:700 }}>{name.slice(0,2).toUpperCase()}</span>
      }
    </div>
  );
};
